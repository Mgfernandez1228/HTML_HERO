  ...
  return (
    <>
      <div className="relative flex flex-col items-center justify-center min-h-screen w-full bg-black animate-gradient text-white px-4 sm:px-8">
        <div className="relative z-10 flex flex-col items-center gap-6 sm:gap-10 lg:gap-12">
          
          <div className="flex flex-col items-center gap-3">
            <h1 
              style={{fontFamily: '"gameboy", "Courier New", Courier, monospace'}} 
              className="font-extrabold text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-white 
          ...
          <div className="flex flex-col items-center justify-center bg-white/5 border-2 border-white/20 p-8 rounded-lg backdrop-blur-sm">
            <span style={{fontFamily: '"gameboy", monospace'}} className="text-gray-400 text-sm uppercase tracking-tighter mb-2">Total Score</span>
            <h2 
              style={{fontFamily: '"gameboy", "Courier New", Courier, monospace'}}
              className="text-5xl sm:text-7xl md:text-8xl text-yellow-400 drop-shadow-[0_0_10px_#eab308]"
            >
              {score.toString().padStart(6, '0')}
            </h2>
            {/* Display the sync status beneath the score */}
            <p className="mt-3 text-sm font-mono text-gray-500 uppercase">{syncStatus}</p>
          </div>
