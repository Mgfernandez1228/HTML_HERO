...
export default function Navbar() {
  ...
  return (
    <>
      ...
      <nav className="fixed top-0 left-0 w-full h-20 z-[70] flex items-center justify-between px-6 bg-black/90 backdrop-blur-md border-b border-cyan-500/30">
        <div 
          onClick={() => { navigate('/'); setIsOpen(false); }}
          style={navFontStyle}
          className="text-xl sm:text-2xl font-bold text-white cursor-pointer drop-shadow-[0_0_10px_#00ffff]"
        >
        ...
        <div className="hidden md:flex items-center gap-10">
          <button onClick={() => navigate('/Title')} style={navFontStyle} className="text-sm tracking-widest text-white hover:text-cyan-400 transition-colors uppercase">Game</button>
